...
These are the dependencies currently used by PepeMint. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/pepemintnl
Keybase  - https://keybase.io/team/pepemint/
