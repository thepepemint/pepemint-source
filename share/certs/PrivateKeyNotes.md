...
unlocked to sign the PepeMint-Qt.app bundle.
...
allowing somebody to distribute a PepeMint-Qt.app or pepemint-qt-setup.exe with a valid
...
that the pepemint-qt.exe file inside the installer had not been tampered with.
