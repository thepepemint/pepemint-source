...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pepemint-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pepemint-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pepemint transaction") + "\n" +
              "  pepemint-tx [options] -create [commands]   " + _("Create hex-encoded pepemint transaction") + "\n" +
              "\n";
