 ...
 * between pepemintd, and pepemint-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pepemint>";
    const std::string URL_WEBSITE = "<https://pepemint.me//>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The PepeMint Developers", 2025)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find PepeMint useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("PepeMint More version %s\n", FormatFullVersion());
}
