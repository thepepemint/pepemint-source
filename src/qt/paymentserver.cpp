...
const QString BITCOIN_IPC_PREFIX("pepemint:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/pepemint-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/pepemint-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/pepemint-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click pepemint: links
...
//
// OSX-specific way of handling pepemint: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in pepemint: URIs
