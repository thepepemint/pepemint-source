...
#if defined(NDEBUG)
# error "PepeMint cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "PepeMint Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("pepemint-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // PepeMint also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // PepeMint also requires low S in sigs
