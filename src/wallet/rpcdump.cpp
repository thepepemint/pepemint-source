...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"pepemintaddress\"\n"
            "\nReveals the private key corresponding to 'pepemintaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"pepemintaddress\"   (string, required) The pepemint address for the private key\n"
            "\nResult:\n"
